 ...
 */
function cog_engage_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['cog_engage_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('cog_engage sample setting'),
  '#default_value' => theme_get_setting('cog_engage_example'),
